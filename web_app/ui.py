...
def index():
  ...
  return render_template('index.html', sets=sets, base_path=base_path, get_location=system.get_location)
...
def full_set(set_id):
  ...
  # get_location is a function that is called
  return render_template('set.html', set=set, base_path=base_path, get_location=system.get_location, no_more = True)
